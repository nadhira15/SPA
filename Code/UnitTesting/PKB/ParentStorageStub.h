...
*/
unordered_set<int> ancestors[4] = { {5}, {5, 6}, {5}, {10} };
unordered_set<int> descendants[3] = { {6, 7, 8}, {7}, {11} };
unordered_set<int> parents = { 5, 6, 10 };
unordered_set<int> children = { 6, 7, 8, 11 };
unordered_set< pair<int, int>, intPairhash> parentPair = { pair<int, int>(5, 6), pair<int, int>(6, 7),
														pair<int, int>(5, 8), pair<int, int>(10, 11) };
unordered_set< pair<int, int>, intPairhash> parentStarPair = { pair<int, int>(5, 6), pair<int, int>(5, 7),
															pair<int, int>(5, 8), pair<int, int>(6, 7),
															pair<int, int>(10, 11) };